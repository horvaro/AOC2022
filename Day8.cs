namespace AOC2022
{
    public class Day8 : Day
    {
        public static void Part1()
        {
            ...
            var forestMap = new int[inputLines.Length, inputLines[0].Length];
        ...
        private static void Part2(int[,] forestMap)
        {
            StartExec();
        ...
        private static int GetViewDistUpwards(int column, int row, int[,] map)
        {
        ...
        private static int GetViewDistDownwards(int column, int row, int[,] map)
        {
        ...
        private static int GetViewDistLeft(int column, int row, int[,] map)
        {
            if (row == 0) return 0;
            var tree = map[column, row];
            var viewDist = 0;
        ...
        private static int GetViewDistRight(int column, int row, int[,] map)
        {
